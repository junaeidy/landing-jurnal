...
export default function JournalPage({ auth }) {
    ...
    return (
        <>
            <Head title={journalT?.find_title} />
            ...
            <div>
                {/* Hero Section */}
                <section className="relative py-24 md:py-32 bg-gradient-to-br from-[#f5f7fa] to-[#c3cfe2] overflow-hidden">
